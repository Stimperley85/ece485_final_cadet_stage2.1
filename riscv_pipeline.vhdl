   ...
   component alu_control is
    ...
    component pipeline_registers 
        Port (
            ...
            if_id_npc : in STD_LOGIC_VECTOR(31 downto 0) := (others => '0');--npc
            --if_id_alu_result : --alu result
            if_id_alu_op : in STD_LOGIC_VECTOR(3 downto 0);--alu op
            if_id_imm : in STD_LOGIC_VECTOR(31 downto 0);--imm
            if_id_instr : in  STD_LOGIC_VECTOR(31 downto 0);
            if_id_reg1_data : in STD_LOGIC_VECTOR(31 downto 0);--reg1
            if_id_reg2_data : in STD_LOGIC_VECTOR(31 downto 0);--reg2
            if_id_rs1 : in STD_LOGIC_VECTOR(4 downto 0);--rs1
            if_id_rs2 : in STD_LOGIC_VECTOR(4 downto 0);--rs2
            if_id_rd : in STD_LOGIC_VECTOR(4 downto 0);--rd
...
--------------------------------------------------------------------------------
    ...
    reg_file_inst: reg_file
        ...
        rs1       => if_id_rs1,
        rs2       => if_id_rs2,
        rd        => mem_wb_rd, --if_id_rd, --mem_wb_rd,
        data_in   => wb_data,
        data_out1 => reg1_data,
        data_out2 => reg2_data
    );    
